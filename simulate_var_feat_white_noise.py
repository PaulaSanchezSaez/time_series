...
def simulate_drw_SF(seed,time_range,dtime,mag,errmag,tau,SFinf,nwalkers_SF,nit_SF,phot_noise,nsamples_DRW,do_SF,do_DRW,sampling,timesamp):
    ...
    t,y,ysig,y_obs,ysig_obs=lc.white_noise(seed,time_range,dtime,mag,errmag,SFinf,sampling,timesamp)
...
#short sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.2,50,200,True,50000,True,True,True,tobs_short,'var_feat_white_noise_shortQUESTsampling_amp02_err002_SF_DRW.txt')
del results0

#med sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.2,50,200,True,50000,True,True,True,tobs_med,'var_feat_white_noise_medQUESTsampling_amp02_err002_SF_DRW.txt')
del results0

#long sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.2,50,200,True,50000,True,True,True,tobs_long,'var_feat_white_noise_longQUESTsampling_amp02_err002_SF_DRW.txt')
del results0

#super long sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.2,50,200,True,50000,True,True,True,tobs_super_long,'var_feat_white_noise_super_longQUESTsampling_amp02_err002_SF_DRW.txt')
del results0


#short sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.02,50,200,True,50000,True,True,True,tobs_short,'var_feat_white_noise_shortQUESTsampling_amp002_err002_SF_DRW.txt')
del results0

#med sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.02,50,200,True,50000,True,True,True,tobs_med,'var_feat_white_noise_medQUESTsampling_amp002_err002_SF_DRW.txt')
del results0

#long sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.02,50,200,True,50000,True,True,True,tobs_long,'var_feat_white_noise_longQUESTsampling_amp002_err002_SF_DRW.txt')
del results0

#super long sampling
results0=run_sim(1000,20,1700,3,19,0.02,0,0.02,50,200,True,50000,True,True,True,tobs_super_long,'var_feat_white_noise_super_longQUESTsampling_amp002_err002_SF_DRW.txt')
del results0
